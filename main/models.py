...
class Main(models.Model):
 ...
 ## for Advert images start
    adurl1 = models.TextField(default="")
    adname = models.TextField(default="")

    adurl2 = models.TextField(default="")
    adname2 = models.TextField(default="")
 ## for Advert images  images end
